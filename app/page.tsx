...
export default function Page() {
  ...
  console.log(showSidebar,"showsidear")
  return (
...
{/* <button type="button" className="inline-flex items-center p-2 mt-20 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside
 className={`fixed top-20 left-0 z-40 w-64 h-screen bg-gray-800 text-white transition-transform duration-800 ease-in-out transform ${
